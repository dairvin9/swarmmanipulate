...
var varyingDirectionTask = _.extend({}, baseTask, baseController, {
    taskName: "varying_direction",
    taskMode: "default",
    instructions: "",
    ...
    +' This experiment varies the response of the robots to commands.'
	+' If a robot steps on a mat, its response to an instruction will change.'
...
// varyingDirectionTask is not defined below for some reason
for (var v in varyingDirectionTask) {
    if (typeof varyingDirectionTask[v] == "function") {
        varyingDirectionTask[v] = _.bind( varyingDirectionTask[v], varyingDirectionTask );
    }
}

// register our task with the application
app.registerTask( varyingDirectionTask );
